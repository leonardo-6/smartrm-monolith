...
import com.lsl.smartrm.smartrmmonolith.trade.domain.remote.TradePayService;
...
public class MonolithTradePayServiceImpl implements TradePayService {
  ...
  @Autowired
  com.lsl.smartrm.smartrmmonolith.payment.application.service.PayService payService;
