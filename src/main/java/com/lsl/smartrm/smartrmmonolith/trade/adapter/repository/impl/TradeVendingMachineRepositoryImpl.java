package com.lsl.smartrm.smartrmmonolith.trade.adapter.repository.impl;

import com.lsl.smartrm.smartrmmonolith.device.domain.cabinet.CabinetDoorState;
...
import com.lsl.smartrm.smartrmmonolith.trade.domain.Order;
import com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachine;
import com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachineState;
import com.lsl.smartrm.smartrmmonolith.trade.domain.repository.OrderRepository;
import com.lsl.smartrm.smartrmmonolith.trade.domain.repository.VendingMachineRepository;
import com.lsl.smartrm.smartrmmonolith.trade.infrastructure.dataobject.TradeCabinetVendingMachineDo;
import com.lsl.smartrm.smartrmmonolith.trade.infrastructure.dataobject.TradeSlotVendingMachineDo;
import com.lsl.smartrm.smartrmmonolith.trade.infrastructure.mapper.TradeCabinetVendingMachineMapper;
import com.lsl.smartrm.smartrmmonolith.trade.infrastructure.mapper.TradeSlotVendingMachineMapper;
...
public class TradeVendingMachineRepositoryImpl implements VendingMachineRepository {
  ...
  public static class TradeVendingMachineRepositoryAspect implements ApplicationContextAware {
    ...
    @Pointcut(
        "execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachine.selectCommodity(..)) "
            + " || execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachine.finishOrder(..))"
            + " || execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachine.cancelOrder(..)) "
            + " || execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.SlotVendingMachine.ready(..))")
    private void slotUpdate() {

    }

    @Pointcut(
        "execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.CabinetVendingMachine.open(..)) "
            + "|| execution(* com.lsl.smartrm.smartrmmonolith.trade.domain.CabinetVendingMachine.onLocked(..))")
