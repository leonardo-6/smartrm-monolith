package com.lsl.smartrm.smartrmmonolith.trade.domain;

import com.google.common.collect.Maps;
import com.lsl.smartrm.smartrmmonolith.device.domain.event.PopSuccessEvent;
import com.lsl.smartrm.smartrmmonolith.infracore.aggregate.AggregateBase;
...
import com.lsl.smartrm.smartrmmonolith.infracore.idgenerator.UniqueIdGeneratorUtil;
...
public class SlotVendingMachine extends AggregateBase {
  ...
  public PaymentQrCode selectCommodity(Collection<StockedCommodity> commodities,
    ...
    emitEvent(new OrderCreatedEvent( curOrder));//this.machineId,
